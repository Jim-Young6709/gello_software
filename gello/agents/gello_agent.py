...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    # Left xArm850
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT8ISVLF-if00-port0": DynamixelRobotConfig(
    ...
    # Right xArm850
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT8ISV6J-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6),
        joint_offsets=(
            1*np.pi/2,
            2*np.pi/2,
    ...
    # Right xArm6
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT7WBGG1-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6),
        joint_offsets=(
            2*np.pi/2,
            2*np.pi/2,
    ...
    # Left xArm6
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT8ISEQG-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6),
        joint_offsets=(
            4*np.pi/2,
            2*np.pi/2,
